...
from rcnn.symbol import get_resnet_test, get_vgg_rpn_test
...
bq = {'d00':'1','d01':'2','d10':'3','d11':'4','d20':'5','d40':'6','d43':'7','d44':'8','d30':2}
    ...
    for image_name in listfile:
        ...
        for ind, boxes in enumerate(boxes_this_image):
            if len(boxes) > 0:
                ...
                gl = [str(i) for i in [image_name.split('/')[-1],bq[CLASSES[ind]],item[4],xmin, ymin, xmax, ymax]]
